...
- days: array of strings — one per day. Each string must be a READABLE phrase that names the actual place and what happens there. Do NOT use cryptic shorthand like "back same day", "full day", "transit". Always name the base city when returning (e.g. "Day trip to Galle from Colombo, back by evening"). Always name specific activities (e.g. "Scuba diving in Hikkaduwa" not "Scuba"). Use **double asterisks** sparingly — only bold the 1-2 most important words per day (the main destination or a standout activity). Never bold the same place twice across days. Not every day needs bold. Good examples: ["**Colombo** → **Galle** (2.5h drive)", "Galle Fort walk and Unawatuna beach", "Day trip to **Hikkaduwa** for scuba diving, return to Galle", "Mirissa beach day and **Coconut Tree Hill** at sunset", "Drive back to Colombo (2.5h)"]
